...
public class LoanPersistenceResultData {

    public static LoanPersistenceResult.LoanPersistenceResultBuilder buildAnnualLoanPersistenceResult() {
        List<LoanPaymentsDetailsPersistenceResult> paymentDetailDtos = Arrays.asList(
                LoanPaymentsDetailsPersistenceResult.builder()
                        .paymentNumber(1)
